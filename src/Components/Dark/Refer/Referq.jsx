...
import muchic from '../../../assets/muchic.jpg'
        ...
        <div className="flex justify-center mt-[150px]">
            <div className="w-[80%] h-[500px] bg-[#C420FF] rounded-[30px]">
                 <div className="flex items-center h-[450px] justify-center ml-[100px]">
                    <img className='w-[500px] h-[350px] rounded-[50px] mr-[50px]' src={muchic} alt="" />
                 ...
                 <div className="flex gap-[20px] justify-center ">
                    ...
                    <Link to='/d'><div className="bg-black w-[15px] h-[15px] rounded-full cursor-pointer"></div></Link>
                    <div className="bg-white w-[15px] h-[15px] rounded-full cursor-pointer"></div>
                    <Link to='/dw'><div className="bg-black w-[15px] h-[15px] rounded-full cursor-pointer"></div></Link>

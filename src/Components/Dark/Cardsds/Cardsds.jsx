     ...
     <div className="mt-[200px] flex items-center justify-center gap-[100px]">
        ...
        <img src={xuy} className='' alt="" />
            <div className="">
                <p className='text-[#C420FF] text-[50px] '>AI Marketing.</p>
                <p className='text-[50px] text-white '>Optimized Reach.</p>
                <p className='text-white text-[23px] w-[570px] mt-[50px]'>It's all about getting your message in front of the right audience and creating those valuable relationships. Learn More about how DOML can help you do just that - all with a simple, easy-to-use platform.</p>

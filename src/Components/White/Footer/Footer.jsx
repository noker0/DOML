...
const Footer = () => {
  return (
    ...
    <div className="flex justify-center mt-[150px]">
        ...
        <p className='black  flex justify-center mt-[50px]'>Trusted by the world’s most ambitious teams.</p>

        <img src={line} className='mt-[100px] h-[1px] mb-[10px] w-[80%] ml-[10%]' alt="" />
        <div className="flex justify-between w-[80%] ml-[10%] pb-[50px] ">
          <p className='text-black '>Copyright © 2022 DOML. All rights reserved.</p>
          <p className='text-black '>Terms of Use & Privacy Policy</p>
        </div>
    </>
  )
}

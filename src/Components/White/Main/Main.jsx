...
import dangote from '../../../assets/dangotew.png'
    ...
    <>
        <div className="mt-[200px] flex items-center justify-center gap-[100px]">
            <div className="">
                ...
                <p className='text-[80px] text-black  '>Optimized Reach.</p>
                <p className='text-black  text-[25px] w-[700px] mt-[50px]'>Our vision is to revolutionize the way brands and advertisers target, reach</p>
                <img src={line} className='w-[700px] my-[50px]' alt="" />
                <button className='text-black  border-[1px] border-[#C420FF] rounded-full flex p-[7px] items-center gap-[5px] px-[40px]'>Get Started <img src={vector} alt="" /></button>
            </div>
        ...
        <p className='text-black  flex justify-center mt-[50px]'>Trusted by the world’s most ambitious teams.</p>
